 ...
 * 这里的colour只会是FACE_WHITE或者FACE_BLACK
 *
 * */
                           ...
                           enum face_colour colour)
{
    ...
    for (i = 0; i < test_face->order; i++)
    {
        ...
        grid_face *f = (e->face1 == test_face) ? e->face2 : e->face1; // 这里f是相邻的面
